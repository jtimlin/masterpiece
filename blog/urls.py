...
urlpatterns = [
    ...
    path('<slug:slug>/update/', views.UpdatePainting.as_view(),
         name='update_painting'),
    path('<slug:slug>/delete/', views.DeletePainting.as_view(),
    ...
    path('like/<slug:slug>', views.LikePainting.as_view(),
         name='like_painting'),
    path('<slug:slug>', views.PaintingDetail.as_view(),
